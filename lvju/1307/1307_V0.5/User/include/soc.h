...
#define		CAP_RATING_MAX						70
#define		CAP_RATING_DEFAULT				32

#define		SOC_SHOW_MAX							100
...
#define		H_UNIT										(s32)(3600*1000)
#define		S_UNIT										(s32)(1000)
#define		M_UNIT										(s32)(60000)

#define		HOURS(x)									((s32)((x)*H_UNIT))
#define		SECONDS(x)								((s32)((x)*S_UNIT))
#define		MINITES(x)								((s32)((x)*M_UNIT))

#define		AH(x)											((s32)(CURRENT_UNIT*H_UNIT*x))
#define		WH(x)											(s32)(CURRENT_UNIT*VOLTAGE_UNIT*36000*x)

#define		CHARGE_EFFICIENCY_MIN			(u16)(0.88*4096)
#define		EFFICIENCY_SHIFT					12
#define		SOC_1_Q_CONST_CHG					((s64)((float)H_UNIT*CURRENT_UNIT*515/Q_UNIT/SOC_INDEX_MAX))//0xDF28EB
#define		SOC_1_Q_CONST_DIS					((s64)((float)H_UNIT*CURRENT_UNIT*512/Q_UNIT/SOC_INDEX_MAX))//0xDBBA00
#define		SOC_0001_PETG_MAX					((s32)((float)H_UNIT*CURRENT_UNIT*Q_VALUE_MAX/Q_UNIT/SOC_INDEX_MAX))
#define		SOC_1_Q_SHIFT							9


#define		charge_current_larger(x)			(SystemParam.BUS_CURRENT > CURRENT_A(x))
#define		charge_current_smaller(x)			(SystemParam.BUS_CURRENT < CURRENT_A(x))
#define		discharge_current_larger(x)		(SystemParam.BUS_CURRENT < CURRENT_A(-(x)))
#define		discharge_current_smaller(x)	(SystemParam.BUS_CURRENT > CURRENT_A(-(x)))

#define		CAP_TYPE_NUM				9
#define		CAP_ARRAY_X					21
#define		CAP_ARRAY_Y					10
#define		CURRENT_ARRAY_NUM		11
#define		SOC_ARRAY_X					11
#define		SOC_ARRAY_Y					7
#define		VOLT_ARRAY_NUM			10
...
extern void soc_show_process(void), uid_save(void), block_voltage_current_calc(void), system_prepare_to_charge(void);
extern void soc_zero_decrease_process(void), update_cap_array(u16 temp_cap, u8 incflg), block_voltage_current_calc_in_charge(void);
extern void charge_soc_compensation_in_voltage(void), charge_soc_compensation_in_current(void), system_prepare_to_full(void);
extern void system_prepare_to_discharge(void), discharge_zero_detect(void), block_voltage_current_calc_in_discharge(void);
extern void discharge_soc_compensation(void);
extern u8 soc_ocv_process(void);
